...
# ⚠ One entry per naming convention in play, NOT per family: gemma4 splits the tower from its
# projector (``vision_tower.`` / ``embed_vision.``), qwen4_exp keeps both under ``visual.``.
